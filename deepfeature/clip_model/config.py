...
# ----------------------
exp_root = './results'        # directory to store experiment output (checkpoints, logs, etc)
...
cifar_10_root = '/root/data'# CIFAR10
# cifar_100_root = '/root/data'# CIFAR10
...
# mnist_root = '/root/data/MNIST'                                              # MNIST
...
tin_train_root_dir = '/root/data/tiny-imagenet-200/train'        # TinyImageNet Train
tin_val_root_dir = '/root/data/tiny-imagenet-200/val/images'     # TinyImageNet Val
